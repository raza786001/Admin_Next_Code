              ...
              <div className="card-body">
                <div className="dash-widget-header">
                  ...
                  <div className="dash-count">
                    <div className="dash-title">All Rides</div>
                  </div>
                </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="dash-widget-header">
                  ...
                  <div className="dash-count">
                    <div className="dash-title">Cancelled Ride</div>
                  </div>
                </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="dash-widget-header">
                  ...
                  <div className="dash-count">
                    <div className="dash-title">Completed Ride</div>
                  </div>
                </div>
              ...
              <div className="modal-content">
                <div className="modal-body">
                  <div className="nav flex-sm-column flex-row">
                    <h4 className="card-title mt-2 ml-4">Edit Promo Code</h4>
                    <div className="row">
          ...
          >
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                <div className="modal-body">
                  <div className="nav flex-sm-column flex-row">
                    <h4 className="card-title mt-2 ml-4">Add New Promo Code</h4>
                    <div className="row">
                      <div className="col-md-12">
                        <div className="form-group">
                          <input
                        ...
                        <div className="form-group">
                          <input
                            type="text"
                            placeholder="Usage Limit - in Days"
                            className="form-control"
                          />
                        </div>
                        <div className="form-group">
