            ...
            <div className="card">
              <div className="card-body">
                <div className="dash-widget-header">
                  ...
                  <div className="dash-count">
                    <div className="dash-title">Admin</div>
                  </div>
                </div>
                  ...
                  >
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th>C=A-B (Driver Payment Amount)</th>
                        <th>D=Admin Earning Amount</th>
...
export default TransportEarningReport;
