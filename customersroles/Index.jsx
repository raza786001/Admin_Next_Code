...
import $ from "jquery";
const apiUrl = "https://apis-paymax.herokuapp.com/usermgt";

let SlideToggle;

const Customers = () => {
	const [date, setDate] = useState(new Date());
	const [token, setToken] = useState('jhdfgdhjfghdfghdfgdfgdg');
						...
						<div className="modal-dialog" role="document">
							<div className="modal-content">
								...
								<div className="card bg-white">
									<div className="card-body">
										<button type="submit" onClick={submitValue} className="btn btn-primary mr-1">
											Add Customer
                    </button>
										<button
											type="button"
